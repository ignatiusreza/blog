...
I should admit where this essay came from, because I am one of the people I've just described. [Voice Runner](/projects/voice-runner) is an endless runner whose stages are generated from whatever music is playing around you, and that you steer by shouting at it. The idea had been sitting in my head for a year. I never started it, because starting meant an entire field I knew nothing about — tempo tracking, placing each beat where the player _will_ be rather than where they are, and a microphone that somehow has to pick your voice out of the same music it is listening to. A season of evenings before I would know whether any of it was fun. So it stayed an idea, which is exactly the failure mode I've just spent two sections describing.

Learning how any of it worked was part of why I wanted to build it, and it is the thing this way of working gets accused of taking away. It didn't. I know now that the hard part isn't hearing the shout — it's that the microphone hears the music too, and that the answer isn't to separate the two sources at all, but to watch the background level asymmetrically, because music raises the floor over seconds while a shout clears it in milliseconds. A year ago I could not have told you any of that. I could have read my way there — none of it is secret — but that is the same season of evenings I was already avoiding, just spent on papers instead of code. Instead I learned it the way I learned anything from _Gorillas_: against something that already ran, by changing it and running it again. The effort moved. It didn't disappear. Turning an idea into something _playable_ is now an afternoon away, and the education comes with it.
