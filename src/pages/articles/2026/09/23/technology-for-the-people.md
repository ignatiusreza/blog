...
What I didn't expect is what building it this way did for the learning. It didn't skip it. I know now that the hard part isn't hearing the shout — it's that the microphone hears the music too, and that the answer isn't to separate the two sources at all, but to watch the background level asymmetrically, because music raises the floor over seconds while a shout clears it in milliseconds. A year ago I could not have told you any of that, and I don't think I would have got there by reading. I got there the way I got everything out of _Gorillas_: against something that already ran, by changing it and running it again. The effort moved. It didn't disappear. Turning an idea into something _playable_ is now an afternoon away, and the education comes with it.
